...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},r,a]}}})());hljs.registerLanguage("scheme",(()=>{"use strict";return e=>{
var t="[^\\(\\)\\[\\]\\{\\}\",'`;#|\\\\\\s]+",n={$pattern:t,
...
illegal:/\S/,contains:[f,i,m,p,c,u,l,o,d]}}})());hljs.registerLanguage("ruby",(()=>{"use strict";function e(...e){
...
},{begin:e.IDENT_RE+"::",keywords:{built_in:t}},{begin:"->"}]}}})());hljs.registerLanguage("hy",(()=>{"use strict";return e=>{
...
contains:[e.SHEBANG(),u,s,d,m,o,p,c,n,l]}}})());hljs.registerLanguage("shell",(()=>{"use strict";return s=>({
